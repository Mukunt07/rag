  ...
  return (
    <Card className="border border-zinc-200 dark:border-zinc-800 shadow-sm overflow-hidden">
      ...
      <CardContent className="p-6">
        <div className="border-2 border-dashed border-zinc-200 dark:border-zinc-800 rounded-lg p-10 flex flex-col items-center justify-center text-center transition-colors hover:bg-zinc-50 dark:hover:bg-zinc-900/50 hover:border-indigo-500/50 cursor-pointer group">
          ...
          <h3 className="font-medium text-zinc-900 dark:text-zinc-100 mb-1">Click to upload or drag and drop</h3>
          <p className="text-sm text-zinc-500 dark:text-zinc-400 max-w-xs mb-6">
            PDF, DOCX, TXT, or Markdown (max. 50MB)
          </p>
          <Button variant="secondary" className="shadow-none">Select Files</Button>
        </div>
      </CardContent>
    </Card>
  );
